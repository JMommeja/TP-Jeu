...
public class unite_terrestre extends unite{

	public unite_terrestre( String nom, int cout,int porte , int munition, Boolean active , String couleur, int coordoneX , int coordoneY ,int porteDeplacement, int pv) {
